    ...
    public ContaView() {
        cadastrarContaButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                //Logica para chamar o cadastro de contas
                int numConta = Integer.parseInt(textNumConta.getText());
                String nome = textNomeCliente.getText();
                conta = new Conta(numConta, nome, 0.0);
                JOptionPane.showMessageDialog(null, "Conta cadsatrada com sucesso","Sucesso", JOptionPane.INFORMATION_MESSAGE);
            }
        });
        depositarButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                bus.depositar(valor);
                JOptionPane.showMessageDialog(null, "Conta cadsatrada com sucesso","Sucesso", JOptionPane.INFORMATION_MESSAGE);
                labelSaldo.setText(Double.toHexString(conta.getSaldo()));
            }
        });
    }
